		...
		<section class="user-center inner clearfix">
			...
			<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					...
					<form action="${ pageContext.request.contextPath }/cartServlet?method=saveAddress" method="post"class="user-addr__form form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<input class="form-control" name="specific" id="details" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码等信息" maxlength="30" type="text">
							</div>
						</div>
						<!-- <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input class="form-control" name="telephone" id="phone" placeholder="请输入电话号码" type="text">
							</div>
						</div>
						<div class="form-group">
			...
			<script>
					...
					<div class="addr-list">
						<div class="addr-item">
							<div class="tdf1">${c.username}</div>
							<div class="tdf2 tdt-a_l">${c.address}</div>
							<div class="tdf3 tdt-a_l">${c.specific}</div>
							<div class="tdf1">${c.phone}</div>
