		...
		<form name="alipayment" action="${pageContext.request.contextPath}/alipay/alipay.trade.page.pay.jsp" method="post"
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${oid }"/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="U袋商城"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDout_trade_no").value = ${oid};
		document.getElementById("WIDsubject").value ="U袋商城";
