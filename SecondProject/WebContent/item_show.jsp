...
function addCart(){
	...
	location.href = "${pageContext.request.contextPath}/cartServlet?method=add&pid=${product.pid}&countss=" + $number;
}
...
<body>
	...
	<div class="tab-header">
		<div class="inner">
			<div class="pull-left">
				...
				<a href="agent_level.jsp">网店代销</a> <a
					href="temp_article/udai_article4.jsp">帮助中心</a>
			</div>
			<div class="pull-right">
				...
				</c:if> <a href="udai_welcome.jsp">我的U袋</a>
				<a href="${ pageContext.request.contextPath }/orderServlet?method=myOrders&currentPage=1">我的订单</a> <a href="udai_integral.jsp">积分平台</a>
			</div>
		</div>
	</div>
	<!-- 搜索栏 -->
	<div class="top-search">
		<div class="inner">
			<a class="logo" href="index.jsp"><img src="images/icons/logo.jpg"
			...
			<div class="pull-left">
				<ol class="breadcrumb">
					...
					<c:forEach items="${categorylist }" var="c">
						<c:if test="${c.cid == product.cid }">

							<c:forEach items="${categorylist }" var="p">
								<c:if test="${c.parentId == p.cid }">
									<li><a href="item_sale_page.jsp">${p.cname }</a></li>

								</c:if>
							</c:forEach>
							<li class="active">${c.cname }</li>
						</c:if>
					</c:forEach>
				...
				<div class="item-pic__box" id="magnifier">
					<div class="small-box">
						<img class="cover" src="${ctx }/${product.imagelist[3] }"
							alt="重回汉唐 旧忆 原创设计日常汉服女款绣花长褙子吊带改良宋裤春夏"> <span class="hover"></span>
					</div>
					<div class="thumbnail-box">
						<a href="javascript:;" class="btn btn-default btn-prev"></a>
						<div class="thumb-list">
							<ul class="wrapper clearfix">
								<c:forEach items="${product.imagelist }" var="c">
									<li class="item active" data-src="${c }"><img
										class="cover" src="${c }" alt="商品预览图"></li>
								</c:forEach>
							</ul>
						</div>
					...
					<div class="big-box">
						<img src="${ctx }/${product.imagelist[3] }"
							alt="重回汉唐 旧忆 原创设计日常汉服女款绣花长褙子吊带改良宋裤春夏">
					</div>
				</div>
				...
				<div class="item-info__box">
					<div class="item-title">
						<div class="name ep2">${product.pdesc }</div>
						<div class="sale cr">优惠活动：该商品享受8折优惠</div>
					</div>
					<div class="item-price bgf5">
						<div class="price-box clearfix">
							<div class="price-panel pull-left">
								售价：<span class="price">￥${price } <s class="fz16 c9">￥${product.price }</s></span>
							</div>
					...
					<ul class="item-ind-panel clearfix">
						<li class="item-ind-item"><span class="ind-label c9">累计销量</span>
							<span class="ind-count cr">${product.popularity }</span></li>
						<!-- <li class="item-ind-item"><a href=""><span
								class="ind-label c9">累计评论</span> <span class="ind-count cr">1314</span></a>
						</li>
						<li class="item-ind-item"><a href=""><span
								class="ind-label c9">赠送积分</span> <span class="ind-count cg">666</span></a>
						</li> -->
					</ul>
					<div class="item-key">
						<div class="item-sku">
							<dl class="item-prop clearfix">
								...
								<dd>
									...
									<c:forEach items="${product.colorlist }" var="c">
										<li><a class="on" href="javascript:;" role="button"
											data-value="白色" aria-disabled="true"> <span>${c }</span>
										</a></li>
										</c:forEach>
						...
						<div class="item-amount clearfix bgf5">
							...
							<div class="amount-box">
								<div class="amount-widget">
									<input class="amount-input" id= "number" value="1" maxlength="8"
										title="请输入购买量" type="text">
									<div class="amount-btn">
										 <a class="amount-but add"  onclick="add1()"></a>
										 <a class="amount-but sub"  onclick="sub1()"></a>
									</div>
								</div>
								<div class="item-stock">
									<span style="margin-left: 10px;">库存 <b id="Stock">${product.count }</b>
										件
									</span>
								</div>
 <script>
                ...
                obj.value =1;
						...
						<div class="item-action clearfix bgf5">
							<a href="javascript:;" rel="nofollow" data-addfastbuy="true"
								title="点击此按钮，到下一步确认购买信息。" role="button" class="item-action__buy">立即购买</a>
							<a href="javascript:void(0);"  onclick="addCart()" rel="nofollow" data-addfastbuy="true"
								role="button" class="item-action__basket"> <i
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<c:forEach items="${productlist }" var="p" begin="0" end="3">
								<a class="picked-item"
									href="${ctx }/productServlet?method=getProductByPid&pid=${p.pid}">
									<img src="${ctx }/${p.imagelist[0]}" alt="" class="cover">
									<div class="look_price">¥${p.price }</div>
								</a>
							</c:forEach>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href=""> <img
								src="images/temp/S-001-4_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-5_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-6_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href=""> <img
								src="images/temp/S-001-7_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-8_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-9_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href=""> <img
								src="images/temp/S-001-10_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-1_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-2_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a>
						</div>
						<div class="swiper-slide">
							<a class="picked-item" href=""> <img
								src="images/temp/S-001-3_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
							</a> <a class="picked-item" href=""> <img
								src="images/temp/S-001-4_s.jpg" alt="" class="cover">
								<div class="look_price">¥134.99</div>
						...
						<div class="rich-text">
							<p style="text-align: center;">
								<i id="desc-module-1" style="font-size: 0"></i> <img
									src="images/temp/S-001_1.jpg" alt=""><br>
								<img src="images/temp/S-001_2.jpg" alt=""><br> <i
									id="desc-module-2" style="font-size: 0"></i><img
									src="images/temp/S-001_3.jpg" alt=""><br>
								<img src="images/temp/S-001_4.jpg" alt=""><br>
								<img src="images/temp/S-001_5.jpg" alt=""><br>
								<img src="images/temp/S-001_6.jpg" alt=""><br>
								<img src="images/temp/S-001_7.jpg" alt=""><br>
								<img src="images/temp/S-001_8.jpg" alt=""><br> <i
									id="desc-module-3" style="font-size: 0"></i><img
									src="images/temp/S-001_9.jpg" alt=""><br>
								<img src="images/temp/S-001_10.jpg" alt=""><br>
								<img src="images/temp/S-001_11.jpg" alt=""><br>
								<img src="images/temp/S-001_12.jpg" alt=""><br> <i
									id="desc-module-4" style="font-size: 0"></i><img
									src="images/temp/S-001_13.jpg" alt=""><br>
								<img src="images/temp/S-001_14.jpg" alt=""><br>
								<img src="images/temp/S-001_15.jpg" alt=""><br>
								<img src="images/temp/S-001_16.jpg" alt=""><br>
								<img src="images/temp/S-001_17.jpg" alt=""><br>
								<img src="images/temp/S-001_18.jpg" alt=""><br>
								<img src="images/temp/S-001_19.jpg" alt=""><br>
								<img src="images/temp/S-001_20.jpg" alt=""><br>
								<img src="images/temp/S-001_21.jpg" alt=""><br>
								<img src="images/temp/S-001_22.jpg" alt=""><br>
								<img src="images/temp/S-001_23.jpg" alt=""><br>
								<img src="images/temp/S-001_24.jpg" alt=""><br>
								<img src="images/temp/S-001_25.jpg" alt=""><br>
								<img src="images/temp/S-001_26.jpg" alt=""><br>
								<img src="images/temp/S-001_27.jpg" alt=""><br>
								<img src="images/temp/S-001_28.jpg" alt=""><br>
								<img src="images/temp/S-001_29.jpg" alt=""><br>
								<img src="images/temp/S-001_30.jpg" alt=""><br>
								<img src="images/temp/S-001_31.jpg" alt=""><br>
								<img src="images/temp/S-001_32.jpg" alt=""><br>
								<img src="images/temp/S-001_33.jpg" alt=""><br>
								<img src="images/temp/S-001_34.jpg" alt=""><br>
								<img src="images/temp/S-001_35.jpg" alt=""><br>
								<img src="images/temp/S-001_36.jpg" alt=""><br> <i
									id="desc-module-5" style="font-size: 0"></i><img
									src="images/temp/S-001_37.jpg" alt=""><br>
								<img src="images/temp/S-001_38.jpg" alt=""><br>
								<img src="images/temp/S-001_39.jpg" alt=""><br>
								<img src="images/temp/S-001_40.jpg" alt=""><br>
								<img src="images/temp/S-001_41.png" width="790" alt="">
							</p>
						</div>
					</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="evaluate-tab"
						...
						<div class="descCate-content posr bgf5">
							...
							<div class="picked-box">
								<a class="picked-item" href=""> <img
									src="images/temp/S-001-1_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a> <a class="picked-item" href=""> <img
									src="images/temp/S-001-2_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a> <a class="picked-item" href=""> <img
									src="images/temp/S-001-3_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a> <a class="picked-item" href=""> <img
									src="images/temp/S-001-4_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a> <a class="picked-item" href=""> <img
									src="images/temp/S-001-5_s.jpg" class="cover">
									<div class="look_price">¥134.99</div>
								</a>
							</div>
						</div>
	...
	<div class="right-nav">
		<ul class="r-with-gotop">
			...
			<li class="r-toolbar-item"><a href="issues.jsp"
